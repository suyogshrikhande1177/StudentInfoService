...
//                    "Mother Name,Qualification,Address,Mobile,Date of Birth,Date_Of_Admission,Taluka,District,Handicapped"
            for (Student student : students) {
                ...
                row.createCell(7).setCellValue(student.getQualification());
                row.createCell(8).setCellValue(student.getAddress());
                row.createCell(9).setCellValue(student.getMobileNum());
                row.createCell(10).setCellValue(student.getDob());
                row.createCell(11).setCellValue(student.getDtOfAdmsn());
                row.createCell(12).setCellValue(student.getTaluka());
                row.createCell(13).setCellValue(student.getDistrict());
                row.createCell(14).setCellValue(student.getHandicapped());
                rowIdx++;
            }
